...
Begin VB.Form Cetak_2A2 
   ...
   Begin DDActiveReportsViewer2Ctl.ARViewer2 ARV1 
      ...
      _ExtentX        =   30215
      _ExtentY        =   14499
      SectionData     =   "Cetak_2A2.frx":6862
   End
   ...
   Begin VB.Label Label1 
      BackStyle       =   0  'Transparent
      Caption         =   "Rincian Pembayaran Piutang"
      BeginProperty Font 
         Name            =   "Calibri"
         Size            =   27.75
         Charset         =   0
   ...
   Begin VB.Image Image1 
      ...
      Index           =   0
      Left            =   0
      Picture         =   "Cetak_2A2.frx":1F53E
      Stretch         =   -1  'True
      Top             =   0
      Width           =   18735
   End
End
Attribute VB_Name = "Cetak_2A2"
...
sql1 = "select '1' as kode,a.kdpiutang,a.kdcustomer,b.nmcustomer,b.alamat,a.tglbayar,a.urut,c.nmkolektor,a.jmlbayar,a.rpPPH23,a.potongan,(a.jmlbayar + a.rpPPH23 + a.potongan) as total," & vbCrLf & _
    "jns_byr = case when a.trf=1 then 'TRANSFER' else 'TUNAI' end ,a.keterangan from byrpiutangsewa a" & vbCrLf & _
    "left join customer b on a.kdcustomer=b.kdcustomer left join kolektor c on a.kdkolektor=c.kdkolektor " & vbCrLf & _
    "where a.tglbayar between '" & Format(txttgl1, "yyyy/MM/dd") & "' and '" & Format(txttgl2, "yyyy/MM/dd") & "' and " & kata & " "
Else
sql1 = "select '1' as kode,a.kdpiutang,a.kdcustomer,b.nmcustomer,b.alamat,a.tglbayar,a.urut,c.nmkolektor,a.jmlbayar,a.rpPPH23,a.potongan,(a.jmlbayar + a.rpPPH23 + a.potongan) as total," & vbCrLf & _
    "jns_byr = case when a.trf=1 then 'TRANSFER' else 'TUNAI' end ,a.keterangan from byrpiutangsewa a" & vbCrLf & _
    "left join customer b on a.kdcustomer=b.kdcustomer left join kolektor c on a.kdkolektor=c.kdkolektor " & vbCrLf & _
    "where a.tglbayar between '" & Format(txttgl1, "yyyy/MM/dd") & "' and '" & Format(txttgl2, "yyyy/MM/dd") & "' and a.kdkolektor='" & lblkdkolektor & "' and " & kata & ""
End If


sqlT = "select kode, sum(jmlbayar) as jmlbayar,sum(rpPPH23) as rpPPH23,sum(potongan) as potongan,sum(total) as total from (" & sql1 & ") a group by kode"
...
If lblkdkolektor = "" Then
sql = "select a.kdpiutang,d.bln,d.tahun,a.kdcustomer,b.nmcustomer,b.alamat,a.tglbayar,a.urut,c.nmkolektor,a.jmlbayar,a.rpPPH23,a.potongan,(a.jmlbayar + a.rpPPH23 + a.potongan) as total," & vbCrLf & _
    "jns_byr = case when a.trf=1 then 'TRANSFER' else 'TUNAI' end ,a.keterangan from byrpiutangsewa a" & vbCrLf & _
    "left join customer b on a.kdcustomer=b.kdcustomer left join kolektor c on a.kdkolektor=c.kdkolektor LEFT JOIN PIUTANGSEWA d on a.kdpiutang=d.kdpiutang " & vbCrLf & _
    "where a.tglbayar between '" & Format(txttgl1, "yyyy/MM/dd") & "' and '" & Format(txttgl2, "yyyy/MM/dd") & "' and " & kata & " order by a.tglbayar,b.nmcustomer"
Else
sql = "select a.kdpiutang,d.bln,d.tahun,a.kdcustomer,b.nmcustomer,b.alamat,a.tglbayar,a.urut,c.nmkolektor,a.jmlbayar,a.rpPPH23,a.potongan,(a.jmlbayar + a.rpPPH23 + a.potongan) as total," & vbCrLf & _
    "jns_byr = case when a.trf=1 then 'TRANSFER' else 'TUNAI' end ,a.keterangan from byrpiutangsewa a" & vbCrLf & _
    "left join customer b on a.kdcustomer=b.kdcustomer left join kolektor c on a.kdkolektor=c.kdkolektor LEFT JOIN PIUTANGSEWA d on a.kdpiutang=d.kdpiutang" & vbCrLf & _
    "where a.tglbayar between '" & Format(txttgl1, "yyyy/MM/dd") & "' and '" & Format(txttgl2, "yyyy/MM/dd") & "' and a.kdkolektor='" & lblkdkolektor & "' and " & kata & " order by a.tglbayar,b.nmcustomer"
End If
...
.fldjns_byr.DataField = "jns_byr"
.fldtotal.DataField = "total"
.fldtglbayar.DataField = "tglbayar"
...
Set Me.ARV1.ReportSource = AR_2A2
End With
