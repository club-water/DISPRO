...
Begin VB.Form Cetak_3A2 
   ...
   Begin DDActiveReportsViewer2Ctl.ARViewer2 ARV1 
      ...
      _ExtentX        =   30215
      _ExtentY        =   14499
      SectionData     =   "Cetak_3A2.frx":6862
   End
   ...
   Begin VB.Label Label1 
      BackStyle       =   0  'Transparent
      Caption         =   "Rincian Retur Pinjaman"
      BeginProperty Font 
         Name            =   "Calibri"
         Size            =   27.75
         Charset         =   0
   ...
   Begin VB.Image Image1 
      ...
      Index           =   0
      Left            =   0
      Picture         =   "Cetak_3A2.frx":1CEF4
      Stretch         =   -1  'True
      Top             =   0
      Width           =   18735
   End
End
Attribute VB_Name = "Cetak_3A2"
...
sql1 = "select '1' AS KODE,a.tglRpinjam,b.kdRpinjam,a.kdcustomer,c.nmcustomer,c.alamat,b.kdbarang,d.nmbarang,b.unit,b.rupiah,b.keterangan, b.kdpinjam,e.tglpinjam,d.kd1" & vbCrLf & _
      ...
      "left join pinjam e on b.kdpinjam=e.kdpinjam where a.kdgudang ='" & lblkdgudang & "' and a.tglRpinjam between '" & Format(txttgl1, "yyyy/MM/dd") & "' and '" & Format(txttgl2, "yyyy/MM/dd") & "' and a.rtr=1"
...
sql = "select a.tglRpinjam,a.kdRpinjam,a.kdcustomer,c.nmcustomer,c.alamat,b.kdbarang,d.nmbarang,b.unit,b.rupiah,a.keterangan, b.kdpinjam,e.tglpinjam,d.kd1" & vbCrLf & _
      "from Rpinjam a left join Rpinjam_d b on a.kdRpinjam=b.kdRpinjam left join customer c on a.kdcustomer=c.kdcustomer left join barang d on b.kdbarang=d.kdbarang" & vbCrLf & _
      "left join pinjam e on b.kdpinjam=e.kdpinjam where a.kdgudang ='" & lblkdgudang & "' and a.tglRpinjam between '" & Format(txttgl1, "yyyy/MM/dd") & "' and '" & Format(txttgl2, "yyyy/MM/dd") & "' and a.rtr=1 order by a.tglRpinjam,a.kdRpinjam"
...
.fldtglRpinjam.DataField = "tglRpinjam"
.fldkdRpinjam.DataField = "kdRpinjam"
...
.lbl1 = "RETUR PINJAMAN"
.lbl2 = "PINJAMAN"
.lbljudul = "RINCIAN RETUR PINJAMAN"
.LBLKDPJM = "KD PJM"
.LBLTGLPJM = "TGL PJM"
