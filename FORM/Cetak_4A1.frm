...
Begin VB.Form Cetak_4A1 
   ...
   Begin DDActiveReportsViewer2Ctl.ARViewer2 ARV1 
      ...
      _ExtentX        =   30215
      _ExtentY        =   14499
      SectionData     =   "Cetak_4A1.frx":6862
   End
   ...
   Begin VB.Image Image1 
      ...
      Index           =   0
      Left            =   0
      Picture         =   "Cetak_4A1.frx":1CEF4
      Stretch         =   -1  'True
      Top             =   0
      Width           =   18735
   End
End
Attribute VB_Name = "Cetak_4A1"
...
sql1 = "select '1' as kode,a.tglsewa,a.kdsewa,a.nosj,a.nopp,a.kdcustomer,c.nmcustomer,c.alamat,b.kdbarang,d.nmbarang,b.unit,b.keterangan" & vbCrLf & _
      "from sewa a left join sewa_d b on a.kdsewa=b.kdsewa left join customer c on a.kdcustomer=c.kdcustomer left join barang d on b.kdbarang=d.kdbarang" & vbCrLf & _
      "where a.kdgudang ='" & lblkdgudang & "' and a.tglsewa between '" & Format(txttgl1, "yyyy/MM/dd") & "' and '" & Format(txttgl2, "yyyy/MM/dd") & "' "
...
sql = "select a.tglsewa,a.kdsewa,a.nosj,a.nopp,a.kdcustomer,c.nmcustomer,c.alamat,b.kdbarang,d.nmbarang,b.unit,b.keterangan" & vbCrLf & _
      "from sewa a left join sewa_d b on a.kdsewa=b.kdsewa left join customer c on a.kdcustomer=c.kdcustomer left join barang d on b.kdbarang=d.kdbarang" & vbCrLf & _
      "where a.kdgudang ='" & lblkdgudang & "' and a.tglsewa between '" & Format(txttgl1, "yyyy/MM/dd") & "' and '" & Format(txttgl2, "yyyy/MM/dd") & "' order by a.tglsewa,a.nosj,a.kdsewa   "
...
.fldtglsewa.DataField = "tglsewa"
.fldkdsewa.DataField = "kdsewa"
...
.fldtglsewa.WordWrap = False
.fldkdsewa.WordWrap = False
...
Set Me.ARV1.ReportSource = AR_4A1
End With
