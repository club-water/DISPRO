...
Begin VB.Form Close_cek 
   ...
   Begin VSFlex8UCtl.VSFlexGrid datagrid1 
      ...
      FormatString    =   $"Close_cek.frx":EFAC
      ScrollTrack     =   -1  'True
      ScrollBars      =   3
      ScrollTips      =   0   'False
      MergeCells      =   0
   ...
   Begin VB.Image Image1 
      Height          =   7035
      Left            =   0
      Picture         =   "Close_cek.frx":22B27
      Stretch         =   -1  'True
      Top             =   0
      Width           =   8970
   End
End
Attribute VB_Name = "Close_cek"
...
Call max
    ...
    If ms = vbYes Then
        sql = "delete from close_route_plan  where kdclose='" & rs!kdclose & "'"
        con.Execute (sql)
...
Private Sub all()
If txtcari = "" Then
sql = "select a.nmrute,a.kdteknisi,c.nmteknisi,b.data_pertgl,a.kdclose from close_route_plan a left join route_plan b on a.nmrute=b.nmrute and a.kdteknisi=b.kdteknisi left join teknisi c on a.kdteknisi=c.kdteknisi group by a.nmrute,a.kdteknisi,c.nmteknisi,b.data_pertgl,a.kdclose order by data_pertgl desc"
Else
sql = "select a.nmrute,a.kdteknisi,c.nmteknisi,b.data_pertgl,a.kdclose from close_route_plan a left join route_plan b on a.nmrute=b.nmrute and a.kdteknisi=b.kdteknisi left join teknisi c on a.kdteknisi=c.kdteknisi where " & kategori & " like '%" & txtcari & "%' group by a.nmrute,a.kdteknisi,c.nmteknisi,b.data_pertgl,a.kdclose order by b.data_pertgl desc"
End If
...
'For i = 1 To CLng(datagrid1.Row) - 1
'
