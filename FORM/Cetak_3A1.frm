...
Begin VB.Form Cetak_3A1 
   ...
   Begin DDActiveReportsViewer2Ctl.ARViewer2 ARV1 
      ...
      _ExtentX        =   30215
      _ExtentY        =   14499
      SectionData     =   "Cetak_3A1.frx":6862
   End
   ...
   Begin VB.Image Image1 
      ...
      Index           =   0
      Left            =   0
      Picture         =   "Cetak_3A1.frx":1CEF4
      Stretch         =   -1  'True
      Top             =   0
      Width           =   18735
   End
End
Attribute VB_Name = "Cetak_3A1"
...
sql1 = "select '1' as kode,a.tglpinjam,a.kdpinjam,a.nosj,a.nopp,a.status,a.tglpengembalian,a.kdcustomer,c.nmcustomer,c.alamat,b.kdbarang,d.nmbarang,b.unit,b.keterangan" & vbCrLf & _
      "from pinjam a left join pinjam_d b on a.kdpinjam=b.kdpinjam left join customer c on a.kdcustomer=c.kdcustomer left join barang d on b.kdbarang=d.kdbarang" & vbCrLf & _
      "where a.kdgudang ='" & lblkdgudang & "' and a.tglpinjam between '" & Format(txttgl1, "yyyy/MM/dd") & "' and '" & Format(txttgl2, "yyyy/MM/dd") & "'"
Else
sql1 = "select '1' as kode,a.tglpinjam,a.kdpinjam,a.nosj,a.nopp,a.status,a.tglpengembalian,a.kdcustomer,c.nmcustomer,c.alamat,b.kdbarang,d.nmbarang,b.unit,b.keterangan" & vbCrLf & _
      "from pinjam a left join pinjam_d b on a.kdpinjam=b.kdpinjam left join customer c on a.kdcustomer=c.kdcustomer left join barang d on b.kdbarang=d.kdbarang" & vbCrLf & _
      "where a.kdgudang ='" & lblkdgudang & "' and a.tglpinjam between '" & Format(txttgl1, "yyyy/MM/dd") & "' and '" & Format(txttgl2, "yyyy/MM/dd") & "' and a.status='" & CMBStatus.Text & "'"
End If
...
If CMBStatus.ListIndex = 0 Then
sql = "select a.tglpinjam,a.kdpinjam,a.nosj,a.nopp,a.status,a.tglpengembalian,a.kdcustomer,c.nmcustomer,c.alamat,b.kdbarang,d.nmbarang,b.unit,b.keterangan" & vbCrLf & _
      "from pinjam a left join pinjam_d b on a.kdpinjam=b.kdpinjam left join customer c on a.kdcustomer=c.kdcustomer left join barang d on b.kdbarang=d.kdbarang" & vbCrLf & _
      "where a.kdgudang ='" & lblkdgudang & "' and a.tglpinjam between '" & Format(txttgl1, "yyyy/MM/dd") & "' and '" & Format(txttgl2, "yyyy/MM/dd") & "' order by a.tglpinjam,a.nosj,a.kdpinjam   "
      
Else
sql = "select a.tglpinjam,a.kdpinjam,a.nosj,a.nopp,a.status,a.tglpengembalian,a.kdcustomer,c.nmcustomer,c.alamat,b.kdbarang,d.nmbarang,b.unit,b.keterangan" & vbCrLf & _
      "from pinjam a left join pinjam_d b on a.kdpinjam=b.kdpinjam left join customer c on a.kdcustomer=c.kdcustomer left join barang d on b.kdbarang=d.kdbarang" & vbCrLf & _
      "where a.kdgudang ='" & lblkdgudang & "' and a.tglpinjam between '" & Format(txttgl1, "yyyy/MM/dd") & "' and '" & Format(txttgl2, "yyyy/MM/dd") & "' and a.status='" & CMBStatus.Text & "' order by a.tglpinjam,a.nosj,a.kdpinjam   "
End If
