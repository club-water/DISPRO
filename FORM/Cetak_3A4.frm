...
Begin VB.Form Cetak_3A4 
   ...
   Begin DDActiveReportsViewer2Ctl.ARViewer2 ARV1 
      ...
      _ExtentX        =   30215
      _ExtentY        =   14499
      SectionData     =   "Cetak_3A4.frx":6862
   End
   ...
   Begin VB.Image Image1 
      ...
      Index           =   0
      Left            =   0
      Picture         =   "Cetak_3A4.frx":21D70
      Stretch         =   -1  'True
      Top             =   0
      Width           =   18735
   End
End
Attribute VB_Name = "Cetak_3A4"
...
sql1 = "select a.tglpinjam as tgl,a.kdpinjam as kd,'DARI - ' AS U1,c.nmgudang,b.kdbarang,d.nmbarang,b.keterangan,a.nosj,b.unit as masuk,0 as keluar   from pinjam a left join pinjam_d b on" & vbCrLf & _
       "a.kdpinjam=b.kdpinjam left join gudang c on a.kdgudang=c.kdgudang left join barang d on b.kdbarang=d.kdbarang where a.kdcustomer='" & lblkdcustomer & "' " & vbCrLf & _
       "Union" & vbCrLf & _
       "select a.tglRpinjam as tgl,a.kdRpinjam as kd,'KE - ' AS U1,c.nmgudang,b.kdbarang,d.nmbarang,b.keterangan,'' as nosj,0 as masuk,b.unit as keluar   from Rpinjam a left join Rpinjam_d b on" & vbCrLf & _
       "a.kdRpinjam=b.kdRpinjam left join gudang c on a.kdgudang=c.kdgudang left join barang d on b.kdbarang=d.kdbarang where a.kdcustomer='" & lblkdcustomer & "' and a.rtr=1"
