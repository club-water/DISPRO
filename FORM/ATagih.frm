...
Begin VB.Form ATagih 
   ...
   Begin Threed.SSCommand cmdT 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "ATagih.frx":C086
      ButtonStyle     =   4
   End
   Begin VB.Image Image2 
      Height          =   495
      Left            =   8100
      Picture         =   "ATagih.frx":EFAC
      Stretch         =   -1  'True
      Top             =   180
      Width           =   600
   End
   ...
   Begin VB.Image Image1 
      Height          =   7035
      Left            =   0
      Picture         =   "ATagih.frx":22A6E
      Stretch         =   -1  'True
      Top             =   0
      Width           =   8970
   End
End
Attribute VB_Name = "ATagih"
...
ATagih_TU.lblkdteknisi = rs!kdarea
ATagih_TU.txtnmteknisi = rs!nmarea

ATagih_TU.lblkdteknisi.Enabled = False
...
Call max
    ...
    If ms = vbYes Then
        sql = "delete from area_tagih  where kdarea='" & rs!kdarea & "' "
        con.Execute (sql)
...
Private Sub all()
If TXTCARI = "" Then
sql = "select * from area_tagih order by kdarea"
Else
sql = "select * from area_tagih where " & kategori & " like '%" & TXTCARI & "%' order by kdarea"
End If
