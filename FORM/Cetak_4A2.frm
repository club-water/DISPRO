...
Begin VB.Form Cetak_4A2 
   ...
   Begin DDActiveReportsViewer2Ctl.ARViewer2 ARV1 
      ...
      _ExtentX        =   30215
      _ExtentY        =   14499
      SectionData     =   "Cetak_4A2.frx":6862
   End
   ...
   Begin VB.Image Image1 
      ...
      Index           =   0
      Left            =   0
      Picture         =   "Cetak_4A2.frx":1CEF4
      Stretch         =   -1  'True
      Top             =   0
      Width           =   18735
   End
End
Attribute VB_Name = "Cetak_4A2"
...
sql1 = "select '1' as kode ,a.tglRsewa,a.kdRsewa,a.kdcustomer,c.nmcustomer,c.alamat,b.kdbarang,d.nmbarang,b.unit,b.rupiah,b.keterangan, b.kdsewa,e.tglsewa,d.kd1" & vbCrLf & _
       "from Rsewa a left join Rsewa_d b on a.kdRsewa=b.kdRsewa left join customer c on a.kdcustomer=c.kdcustomer left join barang d on b.kdbarang=d.kdbarang" & vbCrLf & _
       "left join sewa e on b.kdsewa=e.kdsewa where a.kdgudang ='" & lblkdgudang & "' and a.tglRsewa between '" & Format(txttgl1, "yyyy/MM/dd") & "' and '" & Format(txttgl2, "yyyy/MM/dd") & "' and a.rtr=1"

sqlT = "select kode,sum(unit) as unit,sum(rupiah) as rupiah from (" & sql1 & ") a group by kode"
...
sql = "select a.tglRsewa,a.kdRsewa,a.kdcustomer,c.nmcustomer,c.alamat,b.kdbarang,d.nmbarang,b.unit,B.RUPIAH,b.keterangan,b.kdsewa,e.tglsewa,d.kd1" & vbCrLf & _
      "from Rsewa a left join Rsewa_d b on a.kdRsewa=b.kdRsewa left join customer c on a.kdcustomer=c.kdcustomer left join barang d on b.kdbarang=d.kdbarang" & vbCrLf & _
      "left join sewa e on b.kdsewa=e.kdsewa where a.kdgudang ='" & lblkdgudang & "' and a.tglRsewa between '" & Format(txttgl1, "yyyy/MM/dd") & "' and '" & Format(txttgl2, "yyyy/MM/dd") & "' and a.rtr=1 order by a.tglRsewa,a.kdRsewa"
...
.fldtglpinjam.DataField = "tglsewa"
.fldkdpinjam.DataField = "kdsewa"
.fldtglRpinjam.DataField = "tglRsewa"
.fldkdRpinjam.DataField = "kdRsewa"
...
.fldtglRpinjam.WordWrap = False
.fldkdRpinjam.WordWrap = False
...
Set Me.ARV1.ReportSource = AR_3A2
End With
