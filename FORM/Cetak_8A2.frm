...
Begin VB.Form Cetak_8A2 
   ...
   Begin DDActiveReportsViewer2Ctl.ARViewer2 ARV1 
      ...
      _ExtentX        =   30215
      _ExtentY        =   14499
      SectionData     =   "Cetak_8A2.frx":6862
   End
   ...
   Begin VB.Image Image1 
      ...
      Index           =   0
      Left            =   0
      Picture         =   "Cetak_8A2.frx":1A6C2
      Stretch         =   -1  'True
      Top             =   0
      Width           =   18735
   End
End
Attribute VB_Name = "Cetak_8A2"
...
sql = "select a.kdkategori,b.nmkategori,sum(a.U_pinjam) as U_pinjam,sum(a.U_sewa) as U_sewa,sum(a.U_gdg) as U_gdg,sum(a.U_pinjam + a.U_sewa + a.U_gdg) as total from RKP_kategoriBRG a left join kategoriBrg b on a.kdkategori=b.kdkategori" & vbCrLf & _
     "where a.tgl <= '" & Format(txttgl1, "yyyy/MM/dd") & "' group by a.kdkategori,b.nmkategori order by a.kdkategori"
...
.fldpjm.DataField = "U_pinjam"
.fldswa.DataField = "U_sewa"
.fldgudang.DataField = "U_gdg"
...
.lblpjm = Format(rs!U_pinjam, "#,###0")
.lblswa = Format(rs!U_sewa, "#,###0")
.lblgudang = Format(rs!U_gdg, "#,###0")
...
.fldgudang.WordWrap = False
.fldtotal.WordWrap = False
End If

Set Me.ARV1.ReportSource = AR_8A2
End With
