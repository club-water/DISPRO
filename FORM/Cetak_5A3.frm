...
Begin VB.Form Cetak_5A3 
   ...
   Begin DDActiveReportsViewer2Ctl.ARViewer2 ARV1 
      ...
      _ExtentX        =   30215
      _ExtentY        =   14499
      SectionData     =   "Cetak_5A3.frx":6862
   End
   ...
   Begin VB.Label Label1 
      BackStyle       =   0  'Transparent
      Caption         =   "Rincian Perbaikan dan Mutasi Barang"
      BeginProperty Font 
         Name            =   "Calibri"
         Size            =   27.75
         Charset         =   0
   ...
   Begin VB.Image Image1 
      ...
      Index           =   0
      Left            =   0
      Picture         =   "Cetak_5A3.frx":1CEF4
      Stretch         =   -1  'True
      Top             =   0
      Width           =   18735
   End
End
Attribute VB_Name = "Cetak_5A3"
...
sql1 = "select '1' as kode,a.tglperbaikan,a.kdperbaikan,a.kdgudang2,e.nmgudang,a.kdteknisi,c.nmteknisi,a.kdbarang + ' - ' + f.nmbarang as ket1,b.kdbarang,d.nmbarang,b.unit,b.harga,b.rupiah,b.keterangan" & vbCrLf & _
       "from perbaikan a left join perbaikan_d b on a.kdperbaikan=b.kdperbaikan left join teknisi c on a.kdteknisi=c.kdteknisi left join barang d on b.kdbarang=d.kdbarang" & vbCrLf & _
       "left join gudang e on a.kdgudang2=e.kdgudang left join barang f on a.kdbarang=f.kdbarang where a.kdgudang1 ='" & lblkdgudang & "' and a.tglperbaikan between '" & Format(txttgl1, "yyyy/MM/dd") & "' and '" & Format(txttgl2, "yyyy/MM/dd") & "' and a.kdkategori='" & lblkdkategori & "' "

sqlT = "select kode, sum(unit) as unit,sum(harga) as harga,sum(rupiah) as rupiah from (" & sql1 & ") a group by kode"
...
sql = "select '1' as kode,a.tglperbaikan,a.kdperbaikan,a.kdgudang2,e.nmgudang,a.kdteknisi,c.nmteknisi,a.kdbarang + ' - ' + f.nmbarang as ket1,b.kdbarang,d.nmbarang,b.unit,b.harga,b.rupiah,b.keterangan" & vbCrLf & _
     "from perbaikan a left join perbaikan_d b on a.kdperbaikan=b.kdperbaikan left join teknisi c on a.kdteknisi=c.kdteknisi left join barang d on b.kdbarang=d.kdbarang" & vbCrLf & _
     "left join gudang e on a.kdgudang2=e.kdgudang left join barang f on a.kdbarang=f.kdbarang where a.kdgudang1 ='" & lblkdgudang & "' and a.tglperbaikan between '" & Format(txttgl1, "yyyy/MM/dd") & "' and '" & Format(txttgl2, "yyyy/MM/dd") & "' and a.kdkategori='" & lblkdkategori & "' order by a.tglperbaikan,a.kdperbaikan"
...
.fldtglperbaikan.DataField = "tglperbaikan"
.fldkdperbaikan.DataField = "kdperbaikan"
.fldnmteknisi.DataField = "nmteknisi"
.fldnmgudang2.DataField = "nmgudang"
.fldkdbarang.DataField = "kdbarang"
.fldnmbarang.DataField = "nmbarang"
...
.lbljudul = "Rincian Perbaikan"
Else
.lbljudul = "Rincian Mutasi Barang"
End If
...
.fldtglperbaikan.WordWrap = False
.fldkdperbaikan.WordWrap = False
.fldnmteknisi.WordWrap = False
.fldnmgudang2.WordWrap = False
.fldkdbarang.WordWrap = False
.fldnmbarang.WordWrap = False
...
Set Me.ARV1.ReportSource = AR_5A3
End With
...
sql = "Select * from kategori where kdkategori in ('04','05') order by kdkategori"
