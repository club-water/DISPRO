...
Begin VB.Form Cetak_5A2 
   ...
   Begin DDActiveReportsViewer2Ctl.ARViewer2 ARV1 
      ...
      _ExtentX        =   30215
      _ExtentY        =   14499
      SectionData     =   "Cetak_5A2.frx":6862
   End
   ...
   Begin VB.Image Image1 
      ...
      Index           =   0
      Left            =   0
      Picture         =   "Cetak_5A2.frx":1CEF4
      Stretch         =   -1  'True
      Top             =   0
      Width           =   18735
   End
End
Attribute VB_Name = "Cetak_5A2"
...
sql = "select a.kdcustomer,c.nmcustomer,c.alamat,b.kdbarang,d.nmbarang,sum(b.unit) as unit " & vbCrLf & _
      "from [Free] a left join Free_d b on a.kdFree=b.kdFree left join customer c on a.kdcustomer=c.kdcustomer left join barang d on b.kdbarang=d.kdbarang" & vbCrLf & _
      "where a.kdgudang ='" & lblkdgudang & "' and a.tglFree between '" & Format(txttgl1, "yyyy/MM/dd") & "' and '" & Format(txttgl2, "yyyy/MM/dd") & "' group by a.kdcustomer,c.nmcustomer,c.alamat,b.kdbarang,d.nmbarang order by c.nmcustomer,c.alamat   "
...
Set Me.ARV1.ReportSource = AR_5A2
End With
