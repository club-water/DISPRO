...
Begin VB.Form List_Customer 
   ...
   Begin VB.CheckBox chkmasalah 
      BackColor       =   &H00000000&
      Caption         =   "Tampilkan data yg belum lengkap saja"
      BeginProperty Font 
         Name            =   "Verdana"
         Size            =   8.25
         Charset         =   0
   ...
   Begin VB.CheckBox chkcust 
      BackColor       =   &H00000000&
      Caption         =   "Tampilkan Customer Dispencer dan Showcase saja"
      BeginProperty Font 
         Name            =   "Verdana"
         Size            =   8.25
         Charset         =   0
   ...
   Begin Threed.SSCommand cmdfs 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "List_Customer.frx":0000
      Caption         =   "&Full Screen"
      Alignment       =   5
      ButtonStyle     =   3
      PictureAlignment=   1
   ...
   Begin DDActiveReportsViewer2Ctl.ARViewer2 ARV1 
      ...
      _ExtentX        =   30215
      _ExtentY        =   14499
      SectionData     =   "List_Customer.frx":6862
   End
   ...
   Begin Threed.SSCommand cmdGO 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "List_Customer.frx":689E
      Caption         =   "&s"
      ButtonStyle     =   4
   End
   Begin Threed.SSCommand cmdPdf 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "List_Customer.frx":A154
      Caption         =   "&s"
      ButtonStyle     =   4
   End
   Begin Threed.SSCommand cmdrtf 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "List_Customer.frx":D33B
      Caption         =   "&s"
      ButtonStyle     =   4
   End
   Begin Threed.SSCommand cmdxls 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "List_Customer.frx":10981
      Caption         =   "&s"
      ButtonStyle     =   4
   End
   Begin Threed.SSCommand cmdCANCEL 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "List_Customer.frx":13E60
   ...
   Begin VB.Image Image1 
      ...
      Index           =   0
      Left            =   0
      Picture         =   "List_Customer.frx":1A6C2
      Stretch         =   -1  'True
      Top             =   0
      Width           =   18735
   End
End
Attribute VB_Name = "List_Customer"
...
Private Sub chkcust_KeyPress(KeyAscii As Integer)
...
Private Sub chkmasalah_KeyPress(KeyAscii As Integer)
On Error Resume Next

If KeyAscii = 13 Then
    If chkmasalah.Value = 1 Then
    chkmasalah.Value = 0
    Else
    chkmasalah.Value = 1
    End If
...
sql1 = "select '1' as kode,a.tglFree,a.kdFree,a.nosj,a.kdcustomer,c.nmcustomer,c.alamat,a.keterangan as ket1,b.kdbarang,d.nmbarang,b.unit,b.keterangan" & vbCrLf & _
      "from [Free] a left join Free_d b on a.kdFree=b.kdFree left join customer c on a.kdcustomer=c.kdcustomer left join barang d on b.kdbarang=d.kdbarang" & vbCrLf & _
      "where a.kdgudang ='" & lblkdgudang & "' and a.tglFree between '" & Format(txttgl1, "yyyy/MM/dd") & "' and '" & Format(txttgl2, "yyyy/MM/dd") & "' "
...
If chkmasalah.Value = 0 Then
kata_masalah = "nmcustomer_IAP <>'@@@'"
Else
kata_masalah = "nmcustomer_IAP =''"
End If
...
sql = "select * from V_list_Cust where tgldibuat between '" & Format(txttgl1, "yyyy/MM/dd") & "' and '" & Format(txttgl2, "yyyy/MM/dd") & "' and " & kata_masalah & " and " & kata_sisa & " order by tgldibuat, kdcustomer "

With AR_LIST_CUST.DC1
.ConnectionString = koneksi
.Source = sql
End With

With AR_LIST_CUST
.fldtgldibuat.DataField = "tgldibuat"
.fldkdcustomer.DataField = "kdcustomer"
.fldnmcustomer.DataField = "nmcustomer"
.fldalamat.DataField = "alamat"
.fldkdcustomer_IAP.DataField = "kdcustomer_IAP"
.fldnmcustomer_IAP.DataField = "NMCUSTOMER_iAP"
.fldalamat_IAP.DataField = "alamat_iap"
.fldnmpic.DataField = "nmpic"
.fldnmsp.DataField = "nmsp"
.fldnmcabang.DataField = "nmcabang"
