...
Begin VB.Form Perbaikan_DTU 
   ...
   Begin Threed.SSCommand cmdCANCEL 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "Perbaikan_DTU.frx":0000
   ...
   Begin Threed.SSCommand cmdsimpan 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "Perbaikan_DTU.frx":6862
      Caption         =   "&s"
      ButtonStyle     =   4
   End
   Begin Threed.SSCommand cmdhrg 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "Perbaikan_DTU.frx":92CF
      ButtonStyle     =   4
   End
   ...
   Begin VB.Image Image4 
      Height          =   630
      Left            =   8280
      Picture         =   "Perbaikan_DTU.frx":BB01
      Stretch         =   -1  'True
      Top             =   180
      Width           =   735
   End
   ...
   Begin VB.Label lblrupiah 
      ...
      Width           =   2265
   End
   Begin VB.Label lblkdperbaikan_d 
      BorderStyle     =   1  'Fixed Single
      Height          =   330
      Left            =   2700
      TabIndex        =   7
   ...
   Begin VB.Image Image1 
      Height          =   3390
      Left            =   0
      Picture         =   "Perbaikan_DTU.frx":BEC1
      Stretch         =   -1  'True
      Top             =   0
      Width           =   9150
   End
End
Attribute VB_Name = "Perbaikan_DTU"
...
sqlA = "select a.kdbarang,sum(a.unit) as UKeluar,b.kdpo from perbaikan_d a left join perbaikan b  on a.kdperbaikan =b.kdperbaikan where b.kdpo ='" & Perbaikan_D.txtkdPO & "' group by a.kdbarang,b.kdpo"
...
sqlA1 = "select a.kdbarang,b.nmbarang,a.unit,isnull(c.Ukeluar,0) as Ukeluar,b.satuan,a.keterangan,a.kdpo_d from po_d a left join barang b " & vbCrLf & _
        "on a.kdbarang=b.kdbarang left join (" & sqlA & ") c on a.kdPO=c.kdPO and a.kdbarang=c.kdbarang where a.kdpo='" & Perbaikan_D.txtkdPO & "' "
...
sql1 = "select kdbarang,sum(U_beli + U_Rpinjam + U_Rsewa + M_unit - U_free - U_pinjam - U_sewa  - K_unit - repair) as unit," & vbCrLf & _
        ...
        "from RKP_stok where kdgudang='" & Perbaikan_D.lblkdgudang1 & "' and tgl <= '" & Format(Perbaikan_D.txttglperbaikan, "yyyy/MM/dd") & "' and kdbarang='" & lblkdbarang & "' group by kdbarang"
...
End If
    ...
    Else
         ...
         Call cek_POminta
             ...
             sql = "update perbaikan_D set unit=" & CCur(txtunit) & ",harga=" & CCur(txtharga) & ",rupiah=" & CCur(lblrupiah) & ",keterangan='" & UCase(txtketerangan) & "',klik_hrg=" & klik & " where kdperbaikan_D='" & lblkdperbaikan_d & "'"
             con.Execute (sql)
             MsgBox "Data Telah di Ubah", vbInformation, "Informasi !"

             Perbaikan_D.TimerAll.Interval = 10
