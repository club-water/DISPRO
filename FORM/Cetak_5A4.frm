...
Begin VB.Form Cetak_5A4 
   ...
   Begin DDActiveReportsViewer2Ctl.ARViewer2 ARV1 
      ...
      _ExtentX        =   30215
      _ExtentY        =   14499
      SectionData     =   "Cetak_5A4.frx":6862
   End
   ...
   Begin VB.Label Label1 
      BackStyle       =   0  'Transparent
      Caption         =   "Rekap Perbaikan Per Barang"
      BeginProperty Font 
         Name            =   "Calibri"
         Size            =   27.75
         Charset         =   0
   ...
   Begin VB.Image Image1 
      ...
      Index           =   0
      Left            =   0
      Picture         =   "Cetak_5A4.frx":1CEF4
      Stretch         =   -1  'True
      Top             =   0
      Width           =   18735
   End
End
Attribute VB_Name = "Cetak_5A4"
...
sql1 = "select '1' as kode,a.kdbarang,f.kd1 , f.nmbarang,c.nmkategori ,sum(b.rupiah) as rupiah " & vbCrLf & _
      "from perbaikan a left join perbaikan_d b on a.kdperbaikan=b.kdperbaikan left join barang f on a.kdbarang=f.kdbarang left join kategoriBRG c on f.kdkategori=c.kdkategori where a.kdgudang1 ='" & lblkdgudang & "' and a.tglperbaikan between '" & Format(txttgl1, "yyyy/MM/dd") & "' and '" & Format(txttgl2, "yyyy/MM/dd") & "' and a.kdkategori='04' group by a.kdbarang,f.kd1 , f.nmbarang,c.nmkategori "
...
sql = "select a.kdbarang,f.kd1 , f.nmbarang,c.nmkategori ,sum(b.rupiah) as rupiah " & vbCrLf & _
      "from perbaikan a left join perbaikan_d b on a.kdperbaikan=b.kdperbaikan left join barang f on a.kdbarang=f.kdbarang left join kategoriBRG c on f.kdkategori=c.kdkategori where a.kdgudang1 ='" & lblkdgudang & "' and a.tglperbaikan between '" & Format(txttgl1, "yyyy/MM/dd") & "' and '" & Format(txttgl2, "yyyy/MM/dd") & "' and a.kdkategori='04' group by a.kdbarang,f.kd1 , f.nmbarang,c.nmkategori order by b.rupiah desc"
...
Set Me.ARV1.ReportSource = AR_5A4
End With
