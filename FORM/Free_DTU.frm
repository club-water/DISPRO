...
Begin VB.Form Free_DTU 
   ...
   Begin VB.Image Image1 
      Height          =   3390
      Left            =   0
      Picture         =   "Free_DTU.frx":BEC1
      Stretch         =   -1  'True
      Top             =   0
      Width           =   9150
   End
End
Attribute VB_Name = "Free_DTU"
...
sqlA = "select a.kdbarang,sum(a.unit) as UKeluar,b.kdpo from FREE_d a left join free b  on a.kdFree =b.kdfree where b.kdpo ='" & Free_D.txtkdPO & "' group by a.kdbarang,b.kdpo"
...
sqlA1 = "select a.kdbarang,b.nmbarang,a.unit,isnull(c.Ukeluar,0) as Ukeluar,b.satuan,a.keterangan,a.kdpo_d from po_d a left join barang b " & vbCrLf & _
        "on a.kdbarang=b.kdbarang left join (" & sqlA & ") c on a.kdPO=c.kdPO and a.kdbarang=c.kdbarang where a.kdpo='" & Free_D.txtkdPO & "' "
...
sql1 = "select kdbarang,sum(U_beli + U_Rpinjam + U_Rsewa + M_unit - U_free - U_pinjam - U_sewa  - K_unit - repair) as unit," & vbCrLf & _
        ...
        "from RKP_stok where kdgudang='" & Free_D.lblkdgudang & "' and tgl <= '" & Format(Free_D.txttglfree, "yyyy/MM/dd") & "' and kdbarang='" & lblkdbarang & "' group by kdbarang"
    ...
    Else
         ...
         Call cek_POminta
             ...
             Else
                 ...
                 sql = "update free_d set unit=" & CCur(txtunit) & ",harga=" & CCur(txtharga) & ",rupiah=" & CCur(lblrupiah) & ",keterangan='" & UCase(txtketerangan) & "' where kdfree_d='" & lblkdfree_d & "'"
                 con.Execute (sql)
                 MsgBox "Data Telah di Ubah", vbInformation, "Informasi !"
    
                 Free_D.TimerALL.Interval = 10
            End If
         End If
