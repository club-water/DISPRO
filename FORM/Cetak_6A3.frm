...
Begin VB.Form Cetak_6A3 
   ...
   Begin DDActiveReportsViewer2Ctl.ARViewer2 ARV1 
      ...
      _ExtentX        =   30215
      _ExtentY        =   14499
      SectionData     =   "Cetak_6A3.frx":6862
   End
   ...
   Begin Threed.SSCommand cmdCLR 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "Cetak_6A3.frx":1F726
      ButtonStyle     =   4
   End
   Begin VB.Label Label1 
      BackStyle       =   0  'Transparent
      Caption         =   "Kartu Pelanggan"
      BeginProperty Font 
         Name            =   "Calibri"
         Size            =   27.75
         Charset         =   0
   ...
   Begin VB.Image Image1 
      ...
      Index           =   0
      Left            =   0
      Picture         =   "Cetak_6A3.frx":21D70
      Stretch         =   -1  'True
      Top             =   0
      Width           =   18735
   End
End
Attribute VB_Name = "Cetak_6A3"
...
If lblkdbarang = "" Then
sql = "select a.* , b.nmgudang from kartu_pelanggan a left join gudang b on a.kdgudang=b.kdgudang where a.kdcustomer='" & lblkdcustomer & "' order by a.tgl"
Else
sql = "select a.* , b.nmgudang from kartu_pelanggan a left join gudang b on a.kdgudang=b.kdgudang WHERE a.kdcustomer='" & lblkdcustomer & "' and a.kdbarang='" & lblkdbarang & "' order by a.tgl"
End If
...
.fldUfree.DataField = "Ufree"
.fldUpjm.DataField = "Upjm"
.fldUsewa.DataField = "Usewa"
.FLDURpjm.DataField = "URpINJAM"
.FLDURsewa.DataField = "URsewa"
...
.fldUfree.WordWrap = False
.fldUpjm.WordWrap = False
.fldUsewa.WordWrap = False
.FLDURpjm.WordWrap = False
.FLDURsewa.WordWrap = False
.fldketerangan.WordWrap = False

End If
'
Set Me.ARV1.ReportSource = AR_6A3
End With
'
'
Exit Sub
