...
Begin VB.Form Cetak_7A4 
   ...
   Begin DDActiveReportsViewer2Ctl.ARViewer2 ARV1 
      ...
      _ExtentX        =   30215
      _ExtentY        =   14499
      SectionData     =   "Cetak_7A4.frx":6862
   End
   ...
   Begin VB.Label Label1 
      ...
      Caption         =   "Mutasi Pinjaman dan Sewa"
      BeginProperty Font 
         Name            =   "Calibri"
         Size            =   27.75
         Charset         =   0
   ...
   Begin VB.Image Image1 
      ...
      Index           =   0
      Left            =   0
      Picture         =   "Cetak_7A4.frx":1A6C2
      Stretch         =   -1  'True
      Top             =   0
      Width           =   18735
   End
End
Attribute VB_Name = "Cetak_7A4"
...
sql = "exec SP_mutasiDisp @tgl1='" & Format(txttgl1, "yyyy/MM/dd") & "',@tgl2='" & Format(txttgl2, "yyyy/MM/dd") & "'"
...
.fldpjm1.DataField = "pjm1"
.fldswa1.DataField = "swa1"
.fldtotal1.DataField = "total1"

.fldPjm2.DataField = "pjm2"
.fldSwa2.DataField = "swa2"
.fldtotalM.DataField = "totalM"

.fldRpjm2.DataField = "Rpjm2"
.fldRswa2.DataField = "Rswa2"
.fldtotalK.DataField = "totalK"

.fldpjm3.DataField = "pjm3"
.fldSwa3.DataField = "swa3"
.fldtotal3.DataField = "total3"
...
Set Me.ARV1.ReportSource = AR_7A4
End With
