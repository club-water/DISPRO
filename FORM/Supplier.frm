...
Begin VB.Form Supplier 
   ...
   Begin Threed.SSCommand cmdT 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "Supplier.frx":C086
      ButtonStyle     =   4
   End
   Begin VB.Image Image3 
      Height          =   375
      Left            =   6345
      Picture         =   "Supplier.frx":EFAC
      Stretch         =   -1  'True
      Top             =   7965
      Width           =   420
   End
...
Private Sub tbh()
Supplier_TU.LBLKODE = 1
Supplier_TU.Show vbModal
End Sub

Private Sub ubh()
Supplier_TU.LBLKODE = 2
lblpos = rs.AbsolutePosition
kode = 2

Supplier_TU.lblkdsupplier = rs!kdsupplier
Supplier_TU.TXTnmsupplier = rs!nmsupplier
Supplier_TU.txtalamat = rs!alamat
Supplier_TU.txttelp = rs!telp
Supplier_TU.txtketerangan = rs!keterangan
Supplier_TU.lblkdsupplier.Enabled = False
...
Call max
    ...
    If ms = vbYes Then
        sql = "delete from supplier where kdsupplier='" & rs!kdsupplier & "' "
        con.Execute (sql)
...
Else
sql = "select * from supplier where " & kategori & " like '%" & TXTCARI & "%' order by kdsupplier"
End If
