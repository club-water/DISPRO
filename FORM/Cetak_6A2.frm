...
Begin VB.Form Cetak_6A2 
   ...
   Begin DDActiveReportsViewer2Ctl.ARViewer2 ARV1 
      ...
      _ExtentX        =   30215
      _ExtentY        =   14499
      SectionData     =   "Cetak_6A2.frx":6862
   End
   ...
   Begin VB.Image Image1 
      ...
      Index           =   0
      Left            =   0
      Picture         =   "Cetak_6A2.frx":1CEF4
      Stretch         =   -1  'True
      Top             =   0
      Width           =   18735
   End
End
Attribute VB_Name = "Cetak_6A2"
...
Private Sub total()
'
'sql1 = "select '1' as kode,a.tglbpb,a.nobpb,a.kdsupplier,c.nmsupplier,c.alamat,a.keterangan as ket1,b.kdbarang,d.nmbarang,b.unit,b.harga,b.rupiah,b.keterangan" & vbCrLf & _
...
sql = "select a.* , b.nmcustomer,b.alamat from SJ_DETAIL1 a left join customer b on a.kdcustomer=b.kdcustomer " & vbCrLf & _
      "where a.kdgudang ='" & lblkdgudang & "' and a.tgl between '" & Format(txttgl1, "yyyy/MM/dd") & "' and '" & Format(txttgl2, "yyyy/MM/dd") & "' order by a.tgl,a.noSJ   "
...
Set Me.ARV1.ReportSource = AR_6A2
End With
