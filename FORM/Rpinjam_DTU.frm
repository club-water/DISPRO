...
Begin VB.Form Rpinjam_DTU 
   ...
   Begin VB.Image Image1 
      Height          =   3390
      Left            =   0
      Picture         =   "Rpinjam_DTU.frx":BEC1
      Stretch         =   -1  'True
      Top             =   0
      Width           =   9150
   End
End
Attribute VB_Name = "Rpinjam_DTU"
...
Private Sub cek_PJM()
sqlA1 = "select a.kdpinjam,b.tglpinjam,b.kdcustomer,a.kdbarang,SUM(a.unit) as unit from pinjam_d a left join Pinjam b on a.kdpinjam =b.kdpinjam group by a.kdpinjam,b.tglpinjam,b.kdcustomer,a.kdbarang Union All" & vbCrLf & _
...
sqlA2 = "select a.kdbarang,b.nmbarang,sum(a.unit) as unit from (" & sqlA1 & ") a left join barang b on a.kdbarang=b.kdbarang where a.kdcustomer='" & Rpinjam_D.lblkdcustomer & "' group by a.kdbarang,b.nmbarang"
    ...
    Else
         ...
         If LBLKODE = 1 Then
           ...
           If CCur(lblmaxunit) < CCur(txtunit) Then
             ...
             Exit Sub
           Else
             sql = "insert into Rpinjam_d values ('" & UCase(lblkdbarang) & "_" & UCase(Rpinjam_D.lblKDRPinjam) & "','" & UCase(Rpinjam_D.lblKDRPinjam) & "','" & UCase(lblkdbarang) & "'," & CCur(txtunit) & "," & CCur(txtharga) & "," & CCur(lblrupiah) & ",'" & UCase(txtketerangan) & "','" & lblkdPinjam & "')"
             con.Execute (sql)
         ...
         Call cek_PJM
            If CCur(lblmaxunit) < CCur(txtunit) Then
             ...
             Exit Sub
            Else
             sql = "update Rpinjam_d set unit=" & CCur(txtunit) & ",harga = " & CCur(txtharga) & ",rupiah=" & CCur(lblrupiah) & ",keterangan='" & UCase(txtketerangan) & "' where kdRpinjam_d='" & lblkdRpinjam_d & "'"
             con.Execute (sql)
...
Call nul(lblkdbarang)
If Left(Rpinjam_D.lblkdgudang, 2) = "GH" Then
