...
Begin VB.Form Beli 
   ...
   Begin VB.Image Image1 
      Height          =   10860
      Left            =   0
      Picture         =   "Beli.frx":22BD5
      Stretch         =   -1  'True
      Top             =   0
      Width           =   20430
   End
End
Attribute VB_Name = "Beli"
...
Beli_D.txtkdPO = rs!kdPO
Beli_D.lblkdgudang = rs!kdgudang
Beli_D.lblnmgudang = rs!nmgudang
Beli_D.lblkdsupplier = rs!kdsupplier
Beli_D.lblnmsupplier = rs!nmsupplier
Beli_D.lblnoBPB = rs!noBPB
Beli_D.txttglBPB = rs!tglBPB
Beli_D.txtSJ = rs!noSJ
Beli_D.txttglSJ = rs!tglSJ
Beli_D.lblnoEASAP = rs!noeasap

Beli_D.txtketerangan = rs!keterangan
Beli_D.txttglBPB.Enabled = False
Beli_D.cmdBR.Enabled = False
...
If ChkR.Value = 0 Then
    If TXTCARI = "" Then
    sql = "select a.nobpb,a.tglbpb,a.kdgudang,b.nmgudang,a.kdsupplier,c.nmsupplier,a.keterangan,a.nosj,a.tglSJ,a.kdbeli,a.kdPO,a.noEASAP from beli a left join gudang b on a.kdgudang=b.kdgudang " & vbCrLf & _
          "left join supplier c on a.kdsupplier=c.kdsupplier order by a.tglbpb desc,a.nobpb"
    Else
        If CMBCARI.ListIndex < 5 Then
        sql = "select a.nobpb,a.tglbpb,a.kdgudang,b.nmgudang,a.kdsupplier,c.nmsupplier,a.keterangan,a.nosj,a.tglSJ,a.kdbeli,a.kdPO,a.noEASAP from beli a left join gudang b on a.kdgudang=b.kdgudang " & vbCrLf & _
              "left join supplier c on a.kdsupplier=c.kdsupplier where " & kategori & " like '%" & TXTCARI & "%' order by a.tglbpb desc,a.nobpb"
     
        Else
        sql = "select a.nobpb,a.tglbpb,a.kdgudang,b.nmgudang,a.kdsupplier,c.nmsupplier,a.keterangan,a.nosj,a.tglSJ,a.kdbeli,a.kdPO,a.noEASAP from beli a left join gudang b on a.kdgudang=b.kdgudang " & vbCrLf & _
              "left join supplier c on a.kdsupplier=c.kdsupplier where tglbpb = '" & Format(TXTCARI, "yyyy/MM/dd") & "' order by a.tglbpb desc,a.nobpb"
...
Else
    If TXTCARI = "" Then
    sql = "select top " & CLng(txtR) & " a.nobpb,a.tglbpb,a.kdgudang,b.nmgudang,a.kdsupplier,c.nmsupplier,a.keterangan,a.nosj,a.tglSJ,a.kdbeli,a.kdPO,a.noEASAP from beli a left join gudang b on a.kdgudang=b.kdgudang " & vbCrLf & _
          "left join supplier c on a.kdsupplier=c.kdsupplier order by a.tglbpb desc,a.nobpb"
    Else
        If CMBCARI.ListIndex < 5 Then
        sql = "select top " & CLng(txtR) & " a.nobpb,a.tglbpb,a.kdgudang,b.nmgudang,a.kdsupplier,c.nmsupplier,a.keterangan,a.nosj,a.tglSJ,a.kdbeli,a.kdPO,a.noEASAP from beli a left join gudang b on a.kdgudang=b.kdgudang " & vbCrLf & _
...
CMBCARI.AddItem "NO. BPB"
CMBCARI.AddItem "GUDANG"
CMBCARI.AddItem "SUPPLIER"
CMBCARI.AddItem "KETERANGAN"
CMBCARI.AddItem "NO EASAP"
CMBCARI.AddItem "TANGGAL BPB"
CMBCARI.ListIndex = 0
